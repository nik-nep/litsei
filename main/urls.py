...
urlpatterns = [
    ...
    path('draft/', draft),
    path('navchalna_robota/', navchalna_robota),
    path('vykhovna_robota/', vykhovna_robota),
    path('metodychna_robota/', metodychna_robota),
    path('rozklad_urokiv/', rozklad_urokiv),
    path('struktura_nr/', struktura_nr),
    path('stypendialne_zabezpechennya/', stypendialne_zabezpechennya),
